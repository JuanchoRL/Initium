...
const CATEGORY_SCORE_MAP: Record<SummaryCategoryKey, AssessmentScoreKey[]> = {
  ...
  softSkillsScore: ['problemSolving', 'leadership', 'strategy', 'ethics'],
};
...
const FIT_SCORE_MAP: Record<keyof CandidateFitScores, AssessmentScoreKey[]> = {
  ...
  behavioralFit: ['problemSolving', 'leadership', 'strategy', 'ethics'],
  communication: ['problemSolving', 'leadership', 'ethics'],
  leadershipPotential: ['leadership', 'strategy', 'ethics'],
  cultureFit: ['problemSolving', 'leadership', 'strategy', 'ethics'],
};
